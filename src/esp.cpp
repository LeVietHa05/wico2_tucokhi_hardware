...
// #define SERVER "smartcabinet.xyz"
// #define PORT 80
// //====================================================
...
// int Floor = 0;
// byte nuidPICC[4];
// unsigned long uidDec, uidDecTemp, lastReadCard; // hien thi so UID dang thap phan
// bool isUIDclear = false;
// //====================================================
...
// 
//     if (millis() - lastReadCard > 15000 && !isUIDclear)
//     {
//         for (byte i = 0; i < 4; i++)
//         {
//             nuidPICC[i] = 0;
